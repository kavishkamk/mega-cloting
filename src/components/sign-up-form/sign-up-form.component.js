...
const SignUpForm = () => {
    ...
    const onSubmitHandler = async event => {
        ...
        try {
            const response = await createAuthUserWithEmailAndPassword(formState.email, formState.password);
            createUserDocumentFromAuth(response.user, { displayName: formState.displayName });
